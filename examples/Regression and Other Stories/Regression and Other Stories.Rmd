...
This gives the same values as `invlogit(posterior_linpred(...))`:
...
```{r}
rstanarm::invlogit(predict(model, newdata = data.frame(dist100=mean(wells$dist100)+1, arsenic=mean(wells$arsenic))))
rstanarm::invlogit(predict(model, newdata = data.frame(dist100=mean(wells$dist100), arsenic=mean(wells$arsenic))))
```
...
```{r}
rstanarm::invlogit(predict(model, newdata = data.frame(dist100=mean(wells$dist100), arsenic=mean(wells$arsenic)+1))) -
rstanarm::invlogit(predict(model, newdata = data.frame(dist100=mean(wells$dist100), arsenic=mean(wells$arsenic))))
```
